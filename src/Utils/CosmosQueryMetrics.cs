...
public class CosmosQueryMetrics
{
    ...
    public async Task<List<T>> QueryItemsWithMetricsAsync<T>(
        string query,
        string databaseName,
        ...
        bool populateIndexMetrics = false)
    {
        ...
        var (results, requestCharge) = await _cosmosQueryEngine.QueryItemsAsync<T>(query, databaseName, containerName, parameters, populateIndexMetrics);
        ...
        bool populateIndexMetrics = false)
    {
        ...
        var (result, requestCharge, errorMessage) = await _cosmosQueryEngine.QuerySingleValueAsync<T>(query, databaseName, containerName, parameters, populateIndexMetrics);
